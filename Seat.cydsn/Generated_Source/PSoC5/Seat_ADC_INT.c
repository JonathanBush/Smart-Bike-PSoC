...
/* `#END`  */
    ...
    ******************************************************************************/
    CY_ISR( Seat_ADC_ISR )
    {
        #ifdef Seat_ADC_ISR_INTERRUPT_CALLBACK
            Seat_ADC_ISR_InterruptCallback();
        #endif /* Seat_ADC_ISR_INTERRUPT_CALLBACK */
