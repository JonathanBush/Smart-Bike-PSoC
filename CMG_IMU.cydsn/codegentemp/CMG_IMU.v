// ======================================================================
// CMG_IMU.v generated from TopDesign.cysch
// 05/02/2019 at 09:59
...
module top ;
	...
	cy_clock_v1_0
		#(.id("0ed902e6-539a-42b1-80a8-1194ec6634c0"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e77f38a6-a01a-4d6b-995a-e1d4073e8cef"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_80_11 Sample_Timer (
        .reset(Net_195),
        .interrupt(Net_1124),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1128),
        .tc(Net_1129),
        .clock(Net_202));
    ...
    Timer_v2_80_13 EncTimer (
        .reset(Net_1143),
        .interrupt(Net_1144),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1148),
        .tc(Net_1149),
        .clock(Net_464));
	...
	cy_psoc3_pins_v1_10
		#(.id("ff6722c2-e59e-4077-aad2-a2c6bc5a88df"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
