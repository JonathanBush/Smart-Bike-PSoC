...
// ADC_SAR_v3_10(ADC_Clock=0, ADC_Clock_Frequency=10105264, ADC_Input_Range=3, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=true, Ref_Voltage=1.024, Ref_Voltage_mV=1024, rm_int=true, Sample_Precharge=4, Sample_Rate=0, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=SAR, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Seat_ADC:SAR, CY_INSTANCE_SHORT_NAME=SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Seat_ADC_SAR, )
...
// ADC_SAR_SEQ_v2_10(ADC_Clock_Frequency=1599984, Adjust=0, ClockSource=0, InputRange=3, NumChannels=3, Reference=0, Resolution=12, rm_int=false, SampleMode=1, SamplePrecharge=4, SampleRate=99999, SampleRate_def=631579, VrefValue=1.024, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_10, CY_CONFIG_TITLE=Seat_ADC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Seat_ADC, CY_INSTANCE_SHORT_NAME=Seat_ADC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Seat_ADC, )
...
module top ;
	...
	wire [0:0] tmpOE__sAn_net;
	wire [0:0] tmpFB_0__sAn_net;
	wire [0:0] tmpIO_0__sAn_net;
	wire [0:0] tmpINTERRUPT_0__sAn_net;
	electrical [0:0] tmpSIOVREF__sAn_net;
	...
	cy_psoc3_pins_v1_10
		...
		sAn
		 (.oe(tmpOE__sAn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sAn_net[0:0]}),
		  .analog({Net_178}),
		  .io({tmpIO_0__sAn_net[0:0]}),
		  .siovref(tmpSIOVREF__sAn_net),
		  .interrupt({tmpINTERRUPT_0__sAn_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sAn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sAp_net;
	wire [0:0] tmpFB_0__sAp_net;
	wire [0:0] tmpIO_0__sAp_net;
	wire [0:0] tmpINTERRUPT_0__sAp_net;
	electrical [0:0] tmpSIOVREF__sAp_net;
	...
	cy_psoc3_pins_v1_10
		...
		sAp
		 (.oe(tmpOE__sAp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sAp_net[0:0]}),
		  .analog({Net_182}),
		  .io({tmpIO_0__sAp_net[0:0]}),
		  .siovref(tmpSIOVREF__sAp_net),
		  .interrupt({tmpINTERRUPT_0__sAp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sAp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sBp_net;
	wire [0:0] tmpFB_0__sBp_net;
	wire [0:0] tmpIO_0__sBp_net;
	wire [0:0] tmpINTERRUPT_0__sBp_net;
	electrical [0:0] tmpSIOVREF__sBp_net;
	...
	cy_psoc3_pins_v1_10
		...
		sBp
		 (.oe(tmpOE__sBp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sBp_net[0:0]}),
		  .analog({Net_190}),
		  .io({tmpIO_0__sBp_net[0:0]}),
		  .siovref(tmpSIOVREF__sBp_net),
		  .interrupt({tmpINTERRUPT_0__sBp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sBp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sBn_net;
	wire [0:0] tmpFB_0__sBn_net;
	wire [0:0] tmpIO_0__sBn_net;
	wire [0:0] tmpINTERRUPT_0__sBn_net;
	electrical [0:0] tmpSIOVREF__sBn_net;
	...
	cy_psoc3_pins_v1_10
		...
		sBn
		 (.oe(tmpOE__sBn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sBn_net[0:0]}),
		  .analog({Net_189}),
		  .io({tmpIO_0__sBn_net[0:0]}),
		  .siovref(tmpSIOVREF__sBn_net),
		  .interrupt({tmpINTERRUPT_0__sBn_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sBn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sCp_net;
	wire [0:0] tmpFB_0__sCp_net;
	wire [0:0] tmpIO_0__sCp_net;
	wire [0:0] tmpINTERRUPT_0__sCp_net;
	electrical [0:0] tmpSIOVREF__sCp_net;
	...
	cy_psoc3_pins_v1_10
		...
		sCp
		 (.oe(tmpOE__sCp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sCp_net[0:0]}),
		  .analog({Net_187}),
		  .io({tmpIO_0__sCp_net[0:0]}),
		  .siovref(tmpSIOVREF__sCp_net),
		  .interrupt({tmpINTERRUPT_0__sCp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sCp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sCn_net;
	wire [0:0] tmpFB_0__sCn_net;
	wire [0:0] tmpIO_0__sCn_net;
	wire [0:0] tmpINTERRUPT_0__sCn_net;
	electrical [0:0] tmpSIOVREF__sCn_net;
	...
	cy_psoc3_pins_v1_10
		...
		sCn
		 (.oe(tmpOE__sCn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sCn_net[0:0]}),
		  .analog({Net_180}),
		  .io({tmpIO_0__sCn_net[0:0]}),
		  .siovref(tmpSIOVREF__sCn_net),
		  .interrupt({tmpINTERRUPT_0__sCn_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sCn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
