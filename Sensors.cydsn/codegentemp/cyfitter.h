...
/* Timer */
#define Timer_CounterHW__CAP0 CYREG_TMR0_CAP0
#define Timer_CounterHW__CAP1 CYREG_TMR0_CAP1
#define Timer_CounterHW__CFG0 CYREG_TMR0_CFG0
#define Timer_CounterHW__CFG1 CYREG_TMR0_CFG1
#define Timer_CounterHW__CFG2 CYREG_TMR0_CFG2
#define Timer_CounterHW__CNT_CMP0 CYREG_TMR0_CNT_CMP0
#define Timer_CounterHW__CNT_CMP1 CYREG_TMR0_CNT_CMP1
#define Timer_CounterHW__PER0 CYREG_TMR0_PER0
#define Timer_CounterHW__PER1 CYREG_TMR0_PER1
#define Timer_CounterHW__PM_ACT_CFG CYREG_PM_ACT_CFG3
#define Timer_CounterHW__PM_ACT_MSK 0x01u
#define Timer_CounterHW__PM_STBY_CFG CYREG_PM_STBY_CFG3
#define Timer_CounterHW__PM_STBY_MSK 0x01u
#define Timer_CounterHW__RT0 CYREG_TMR0_RT0
#define Timer_CounterHW__RT1 CYREG_TMR0_RT1
#define Timer_CounterHW__SR0 CYREG_TMR0_SR0
...
/* RearHall_Pin */
#define RearHall_Pin__0__INTTYPE CYREG_PICU0_INTTYPE0
#define RearHall_Pin__0__MASK 0x01u
#define RearHall_Pin__0__PC CYREG_PRT0_PC0
#define RearHall_Pin__0__PORT 0u
#define RearHall_Pin__0__SHIFT 0u
#define RearHall_Pin__AG CYREG_PRT0_AG
#define RearHall_Pin__AMUX CYREG_PRT0_AMUX
#define RearHall_Pin__BIE CYREG_PRT0_BIE
#define RearHall_Pin__BIT_MASK CYREG_PRT0_BIT_MASK
#define RearHall_Pin__BYP CYREG_PRT0_BYP
#define RearHall_Pin__CTL CYREG_PRT0_CTL
#define RearHall_Pin__DM0 CYREG_PRT0_DM0
#define RearHall_Pin__DM1 CYREG_PRT0_DM1
#define RearHall_Pin__DM2 CYREG_PRT0_DM2
#define RearHall_Pin__DR CYREG_PRT0_DR
#define RearHall_Pin__INP_DIS CYREG_PRT0_INP_DIS
#define RearHall_Pin__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define RearHall_Pin__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define RearHall_Pin__LCD_EN CYREG_PRT0_LCD_EN
#define RearHall_Pin__MASK 0x01u
#define RearHall_Pin__PORT 0u
#define RearHall_Pin__PRT CYREG_PRT0_PRT
#define RearHall_Pin__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define RearHall_Pin__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define RearHall_Pin__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define RearHall_Pin__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define RearHall_Pin__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define RearHall_Pin__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define RearHall_Pin__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define RearHall_Pin__PS CYREG_PRT0_PS
#define RearHall_Pin__SHIFT 0u
#define RearHall_Pin__SLW CYREG_PRT0_SLW

/* Resistor_Pin */
#define Resistor_Pin__0__INTTYPE CYREG_PICU0_INTTYPE2
#define Resistor_Pin__0__MASK 0x04u
#define Resistor_Pin__0__PC CYREG_PRT0_PC2
#define Resistor_Pin__0__PORT 0u
#define Resistor_Pin__0__SHIFT 2u
#define Resistor_Pin__AG CYREG_PRT0_AG
#define Resistor_Pin__AMUX CYREG_PRT0_AMUX
#define Resistor_Pin__BIE CYREG_PRT0_BIE
#define Resistor_Pin__BIT_MASK CYREG_PRT0_BIT_MASK
#define Resistor_Pin__BYP CYREG_PRT0_BYP
#define Resistor_Pin__CTL CYREG_PRT0_CTL
#define Resistor_Pin__DM0 CYREG_PRT0_DM0
#define Resistor_Pin__DM1 CYREG_PRT0_DM1
#define Resistor_Pin__DM2 CYREG_PRT0_DM2
#define Resistor_Pin__DR CYREG_PRT0_DR
#define Resistor_Pin__INP_DIS CYREG_PRT0_INP_DIS
#define Resistor_Pin__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define Resistor_Pin__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define Resistor_Pin__LCD_EN CYREG_PRT0_LCD_EN
#define Resistor_Pin__MASK 0x04u
#define Resistor_Pin__PORT 0u
#define Resistor_Pin__PRT CYREG_PRT0_PRT
#define Resistor_Pin__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define Resistor_Pin__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define Resistor_Pin__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define Resistor_Pin__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define Resistor_Pin__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define Resistor_Pin__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define Resistor_Pin__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define Resistor_Pin__PS CYREG_PRT0_PS
#define Resistor_Pin__SHIFT 2u
#define Resistor_Pin__SLW CYREG_PRT0_SLW
