...
int8 AMuxSeq_1_curChannel = -1;

void AMuxSeq_1_DisconnectAll(void)
{
	AMuxSeq_1_curChannel = -1;
}
...
{
	AMuxSeq_1_curChannel++;
	switch (AMuxSeq_1_curChannel)
	{
	case 10:
	default:
		AMuxSeq_1_curChannel = 0;
	case 0:
		break;
	case 1:
		break;
...
int8 AMuxSeq_2_curChannel = -1;

void AMuxSeq_2_DisconnectAll(void)
{
	AMuxSeq_2_curChannel = -1;
}
...
{
	AMuxSeq_2_curChannel++;
	switch (AMuxSeq_2_curChannel)
	{
	case 16:
	default:
		AMuxSeq_2_curChannel = 0;
	case 0:
		break;
	case 1:
		break;
