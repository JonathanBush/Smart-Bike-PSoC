...
module top ;
    ...
    Counter_v3_0_1 Timer (
        ...
        .up_ndown(1'b1),
        .count(1'b0));
    defparam Timer.CaptureMode = 0;
    defparam Timer.ClockMode = 3;
    defparam Timer.CompareMode = 1;
    defparam Timer.CompareStatusEdgeSense = 1;
    defparam Timer.EnableMode = 0;
    defparam Timer.ReloadOnCapture = 0;
    defparam Timer.ReloadOnCompare = 0;
    defparam Timer.ReloadOnOverUnder = 1;
    defparam Timer.ReloadOnReset = 1;
    defparam Timer.Resolution = 16;
    defparam Timer.RunMode = 0;
    defparam Timer.UseInterrupt = 1;

    EdgeDetect_v1_0 EdgeDetect_Rear (
        .d(Net_45),
        .det(Net_46),
        .clock(Net_47));
    defparam EdgeDetect_Rear.EdgeType = 1;
	...
	wire [0:0] tmpOE__RearHall_Pin_net;
	wire [0:0] tmpIO_0__RearHall_Pin_net;
	wire [0:0] tmpINTERRUPT_0__RearHall_Pin_net;
	electrical [0:0] tmpSIOVREF__RearHall_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6bfc8b5c-e211-4a37-b2cb-414ed188138e"),
		  ...
		  .input_buffer_sel(2'b00))
		RearHall_Pin
		 (.oe(tmpOE__RearHall_Pin_net),
		  .y({1'b0}),
		  .fb({Net_45}),
		  .io({tmpIO_0__RearHall_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__RearHall_Pin_net),
		  .interrupt({tmpINTERRUPT_0__RearHall_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RearHall_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Resistor_Pin_net;
	wire [0:0] tmpFB_0__Resistor_Pin_net;
	wire [0:0] tmpIO_0__Resistor_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Resistor_Pin_net;
	electrical [0:0] tmpSIOVREF__Resistor_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Resistor_Pin
		 (.oe(tmpOE__Resistor_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Resistor_Pin_net[0:0]}),
		  .analog({Net_227}),
		  .io({tmpIO_0__Resistor_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Resistor_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Resistor_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Resistor_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- AMux AMuxSeq_2 start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 AMuxSeq_2(
        .muxin({
            Net_275,
            Net_274,
            Net_273,
    ...
    defparam AMuxSeq_2.muxin_width = 16;
    defparam AMuxSeq_2.init_mux_sel = 16'h0;
    defparam AMuxSeq_2.api_type = 1'b1;
    defparam AMuxSeq_2.one_active = 1;
    defparam AMuxSeq_2.connect_mode = 1;
    ...
    defparam AMuxSeq_1.muxin_width = 10;
    defparam AMuxSeq_1.init_mux_sel = 10'h0;
    defparam AMuxSeq_1.api_type = 1'b1;
    defparam AMuxSeq_1.one_active = 1;
    defparam AMuxSeq_1.connect_mode = 1;
