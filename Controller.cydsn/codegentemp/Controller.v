...
// VDAC8_v1_90(Data_Source=0, Initial_Value=56, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=896, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=Throttle, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Throttle, CY_INSTANCE_SHORT_NAME=Throttle, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Throttle, )
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=57600, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=0, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=false, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=0, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=2, OverSamplingRate=8, ParityType=1, ParityTypeSw=false, RequiredClock=460800, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=false, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UART_v2_50, CY_CONFIG_TITLE=SBUS_UART, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SBUS_UART, CY_INSTANCE_SHORT_NAME=SBUS_UART, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=SBUS_UART, )
module UART_v2_50_1 (
    cts_n,
    tx,
    rts_n,
...
// OpAmp_v1_90(Mode=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=Opamp_Throttle, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_Throttle, CY_INSTANCE_SHORT_NAME=Opamp_Throttle, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Opamp_Throttle, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=1000, CompareValue2=0, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=60000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_Brake, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Brake, CY_INSTANCE_SHORT_NAME=PWM_Brake, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_Brake, )
module PWM_v3_30_3 (
    reset,
    clock,
    tc,
...
module top ;
    ...
    VDAC8_v1_90_0 Throttle (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_86));
    defparam Throttle.Data_Source = 0;
    defparam Throttle.Initial_Value = 56;
    defparam Throttle.Strobe_Mode = 0;
	...
	wire [0:0] tmpOE__Steering_Direction_net;
	wire [0:0] tmpFB_0__Steering_Direction_net;
	wire [0:0] tmpIO_0__Steering_Direction_net;
	wire [0:0] tmpINTERRUPT_0__Steering_Direction_net;
	electrical [0:0] tmpSIOVREF__Steering_Direction_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3252715a-43b3-4818-a181-6456404418a1"),
		  ...
		  .input_buffer_sel(2'b00))
		Steering_Direction
		 (.oe(tmpOE__Steering_Direction_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Steering_Direction_net[0:0]}),
		  .io({tmpIO_0__Steering_Direction_net[0:0]}),
		  .siovref(tmpSIOVREF__Steering_Direction_net),
		  .interrupt({tmpINTERRUPT_0__Steering_Direction_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Steering_Direction_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_50_1 SBUS_UART (
        .cts_n(1'b0),
        .tx(Net_59),
        .rts_n(Net_48),
        .tx_en(Net_49),
        ...
        .rx_data(Net_57),
        .rx_clk(Net_58));
    defparam SBUS_UART.Address1 = 0;
    defparam SBUS_UART.Address2 = 0;
    defparam SBUS_UART.EnIntRXInterrupt = 0;
    defparam SBUS_UART.EnIntTXInterrupt = 0;
    defparam SBUS_UART.FlowControl = 0;
    defparam SBUS_UART.HalfDuplexEn = 0;
    defparam SBUS_UART.HwTXEnSignal = 1;
    defparam SBUS_UART.NumDataBits = 8;
    defparam SBUS_UART.NumStopBits = 2;
    defparam SBUS_UART.ParityType = 1;
    defparam SBUS_UART.RXEnable = 1;
    defparam SBUS_UART.TXEnable = 0;


    assign Net_206 = ~Net_79;


	cy_clock_v1_0
		#(.id("68948b73-904b-45d0-afe8-d9739e263a34"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1250000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Rx_SBUS_net;
	wire [0:0] tmpIO_0__Rx_SBUS_net;
	wire [0:0] tmpINTERRUPT_0__Rx_SBUS_net;
	electrical [0:0] tmpSIOVREF__Rx_SBUS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Rx_SBUS
		 (.oe(tmpOE__Rx_SBUS_net),
		  .y({1'b0}),
		  .fb({Net_79}),
		  .io({tmpIO_0__Rx_SBUS_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_SBUS_net),
		  .interrupt({tmpINTERRUPT_0__Rx_SBUS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_SBUS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    OpAmp_v1_90_2 Opamp_Throttle (
        .Vplus(Net_86),
        .Vout(Net_87),
        .Vminus(Net_88));
    defparam Opamp_Throttle.Mode = 1;

    PWM_v3_30_3 PWM_Brake (
        .reset(Net_160),
        .clock(Net_120),
        .tc(Net_161),
        .pwm1(Net_162),
        ...
        .ph1(Net_171),
        .ph2(Net_172));
    defparam PWM_Brake.Resolution = 16;


	cy_clock_v1_0
		#(.id("43c05331-c153-4168-931c-0b5e47a43ead"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Brake_PWM_net;
	wire [0:0] tmpFB_0__Brake_PWM_net;
	wire [0:0] tmpIO_0__Brake_PWM_net;
	wire [0:0] tmpINTERRUPT_0__Brake_PWM_net;
	electrical [0:0] tmpSIOVREF__Brake_PWM_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Brake_PWM
		 (.oe(tmpOE__Brake_PWM_net),
		  .y({Net_170}),
		  .fb({tmpFB_0__Brake_PWM_net[0:0]}),
		  .io({tmpIO_0__Brake_PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__Brake_PWM_net),
		  .interrupt({tmpINTERRUPT_0__Brake_PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Brake_PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
