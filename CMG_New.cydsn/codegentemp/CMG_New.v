// ======================================================================
// CMG_New.v generated from TopDesign.cysch
// 04/26/2019 at 11:54
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=16, CounterSizeReplacementString=int16, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONFIG_TITLE=Handle_Encoder, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Handle_Encoder, CY_INSTANCE_SHORT_NAME=Handle_Encoder, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Handle_Encoder, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=32768, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=32768, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=32768, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Cnt16, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Gimbal_Encoder:Cnt16, CY_INSTANCE_SHORT_NAME=Cnt16, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Gimbal_Encoder_Cnt16, )
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=16, CounterSizeReplacementString=int16, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONFIG_TITLE=Gimbal_Encoder, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Gimbal_Encoder, CY_INSTANCE_SHORT_NAME=Gimbal_Encoder, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Gimbal_Encoder, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=true, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=100, CompareValue2=0, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=1800, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_CMG, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_CMG, CY_INSTANCE_SHORT_NAME=PWM_CMG, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_CMG, )
module PWM_v3_30_7 (
    reset,
    clock,
    tc,
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=true, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=9, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Sample_Timer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Sample_Timer, CY_INSTANCE_SHORT_NAME=Sample_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Sample_Timer, )
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=true, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=9, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Steering_Timer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Steering_Timer, CY_INSTANCE_SHORT_NAME=Steering_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Steering_Timer, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=2500, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_Steer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Steer, CY_INSTANCE_SHORT_NAME=PWM_Steer, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_Steer, )
module PWM_v3_30_11 (
    reset,
    clock,
    tc,
...
module top ;
    ...
    QuadDec_v3_0_1 Handle_Encoder (
        .quad_A(Net_1072),
        .quad_B(Net_1073),
        .index(1'b0),
        .clock(Net_1069),
        .interrupt(Net_1075));
    defparam Handle_Encoder.CounterResolution = 4;
    defparam Handle_Encoder.UsingGlitchFiltering = 1;
    defparam Handle_Encoder.UsingIndexInput = 0;
	...
	wire [0:0] tmpOE__Gimbal_Encoder_B_net;
	wire [0:0] tmpIO_0__Gimbal_Encoder_B_net;
	wire [0:0] tmpINTERRUPT_0__Gimbal_Encoder_B_net;
	electrical [0:0] tmpSIOVREF__Gimbal_Encoder_B_net;

	cy_psoc3_pins_v1_10
		#(.id("59c1ab5f-11ef-41d7-8009-aa04b9dba266"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Gimbal_Encoder_B
		 (.oe(tmpOE__Gimbal_Encoder_B_net),
		  .y({1'b0}),
		  .fb({Net_1067}),
		  .io({tmpIO_0__Gimbal_Encoder_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Gimbal_Encoder_B_net),
		  .interrupt({tmpINTERRUPT_0__Gimbal_Encoder_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Gimbal_Encoder_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Gimbal_Encoder_A_net;
	wire [0:0] tmpIO_0__Gimbal_Encoder_A_net;
	wire [0:0] tmpINTERRUPT_0__Gimbal_Encoder_A_net;
	electrical [0:0] tmpSIOVREF__Gimbal_Encoder_A_net;

	cy_psoc3_pins_v1_10
		#(.id("dbfb9751-6d7b-4701-b028-88483445f954"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Gimbal_Encoder_A
		 (.oe(tmpOE__Gimbal_Encoder_A_net),
		  .y({1'b0}),
		  .fb({Net_1066}),
		  .io({tmpIO_0__Gimbal_Encoder_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Gimbal_Encoder_A_net),
		  .interrupt({tmpINTERRUPT_0__Gimbal_Encoder_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Gimbal_Encoder_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    QuadDec_v3_0_3 Gimbal_Encoder (
        .quad_A(Net_1066),
        .quad_B(Net_1067),
        .index(1'b0),
        .clock(Net_1069),
        .interrupt(Net_1070));
    defparam Gimbal_Encoder.CounterResolution = 4;
    defparam Gimbal_Encoder.UsingGlitchFiltering = 1;
    defparam Gimbal_Encoder.UsingIndexInput = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("d999e358-37d2-440a-98f5-295dbeb5f576"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bf6e8dc0-15d0-433c-9b8f-8bf645020a21"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    Timer_v2_80_4 Gimbal_Timer (
        .reset(Net_128),
        .interrupt(Net_1060),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1064),
        .tc(Net_1065),
        .clock(Net_135));
    defparam Gimbal_Timer.CaptureCount = 2;
    defparam Gimbal_Timer.CaptureCounterEnabled = 0;
    defparam Gimbal_Timer.DeviceFamily = "PSoC5";
    defparam Gimbal_Timer.InterruptOnCapture = 0;
    defparam Gimbal_Timer.InterruptOnTC = 1;
    defparam Gimbal_Timer.Resolution = 8;
    defparam Gimbal_Timer.SiliconRevision = "0";
	...
	cy_clock_v1_0
		#(.id("39c45e82-2ca3-41c9-892a-f4f26d0b9fa1"),
	...
	cy_psoc3_pins_v1_10
		#(.id("b851ab1a-4547-4be8-9645-8a1f7a8f1838"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("345b9c63-a8fb-4acc-a032-06ab1065451d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__gimbal_motor_net;
	wire [0:0] tmpFB_0__gimbal_motor_net;
	wire [0:0] tmpIO_0__gimbal_motor_net;
	wire [0:0] tmpINTERRUPT_0__gimbal_motor_net;
	electrical [0:0] tmpSIOVREF__gimbal_motor_net;

	cy_psoc3_pins_v1_10
		#(.id("5c50f1bc-a045-46fe-9e2f-e79a01723807"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		gimbal_motor
		 (.oe(tmpOE__gimbal_motor_net),
		  .y({Net_89}),
		  .fb({tmpFB_0__gimbal_motor_net[0:0]}),
		  .io({tmpIO_0__gimbal_motor_net[0:0]}),
		  .siovref(tmpSIOVREF__gimbal_motor_net),
		  .interrupt({tmpINTERRUPT_0__gimbal_motor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__gimbal_motor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__gimbal_direction_net;
	wire [0:0] tmpFB_0__gimbal_direction_net;
	wire [0:0] tmpIO_0__gimbal_direction_net;
	wire [0:0] tmpINTERRUPT_0__gimbal_direction_net;
	electrical [0:0] tmpSIOVREF__gimbal_direction_net;

	cy_psoc3_pins_v1_10
		#(.id("6bcad45d-47d0-4fbe-b03c-15df0b5896a5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		gimbal_direction
		 (.oe(tmpOE__gimbal_direction_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__gimbal_direction_net[0:0]}),
		  .io({tmpIO_0__gimbal_direction_net[0:0]}),
		  .siovref(tmpSIOVREF__gimbal_direction_net),
		  .interrupt({tmpINTERRUPT_0__gimbal_direction_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__gimbal_direction_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_166 = 1'h0;

	wire [0:0] tmpOE__flywheel_motor_net;
	wire [0:0] tmpFB_0__flywheel_motor_net;
	wire [0:0] tmpIO_0__flywheel_motor_net;
	wire [0:0] tmpINTERRUPT_0__flywheel_motor_net;
	electrical [0:0] tmpSIOVREF__flywheel_motor_net;

	cy_psoc3_pins_v1_10
		#(.id("e201739a-168e-4d99-acc6-580117889063"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		flywheel_motor
		 (.oe(tmpOE__flywheel_motor_net),
		  .y({Net_1036}),
		  .fb({tmpFB_0__flywheel_motor_net[0:0]}),
		  .io({tmpIO_0__flywheel_motor_net[0:0]}),
		  .siovref(tmpSIOVREF__flywheel_motor_net),
		  .interrupt({tmpINTERRUPT_0__flywheel_motor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__flywheel_motor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_7 PWM_CMG (
        ...
        .ph1(Net_1444),
        .ph2(Net_1445));
    defparam PWM_CMG.Resolution = 16;
	...
	wire [0:0] tmpOE__BNO_Interupt_net;
	wire [0:0] tmpIO_0__BNO_Interupt_net;
	wire [0:0] tmpINTERRUPT_0__BNO_Interupt_net;
	electrical [0:0] tmpSIOVREF__BNO_Interupt_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c59b282e-e1f3-4337-a9c1-a81927dad1c1"),
		  ...
		  .input_buffer_sel(2'b00))
		BNO_Interupt
		 (.oe(tmpOE__BNO_Interupt_net),
		  .y({1'b0}),
		  .fb({Net_1031}),
		  .io({tmpIO_0__BNO_Interupt_net[0:0]}),
		  .siovref(tmpSIOVREF__BNO_Interupt_net),
		  .interrupt({tmpINTERRUPT_0__BNO_Interupt_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BNO_Interupt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_8 EncTimer (
        .reset(Net_1022),
        .interrupt(Net_1023),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1027),
        .tc(Net_1028),
        .clock(Net_464));
    defparam EncTimer.CaptureCount = 2;
    defparam EncTimer.CaptureCounterEnabled = 0;
    defparam EncTimer.DeviceFamily = "PSoC5";
    defparam EncTimer.InterruptOnCapture = 0;
    defparam EncTimer.InterruptOnTC = 0;
    defparam EncTimer.Resolution = 16;
    defparam EncTimer.SiliconRevision = "0";
    ...
    Timer_v2_80_9 Sample_Timer (
        .reset(Net_195),
        .interrupt(Net_1014),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1018),
        .tc(Net_1019),
        .clock(Net_202));
    ...
    defparam Sample_Timer.Resolution = 8;
	...
	wire [0:0] tmpOE__Handle_Encoder_A_net;
	wire [0:0] tmpIO_0__Handle_Encoder_A_net;
	wire [0:0] tmpINTERRUPT_0__Handle_Encoder_A_net;
	electrical [0:0] tmpSIOVREF__Handle_Encoder_A_net;

	cy_psoc3_pins_v1_10
		#(.id("3cb5493c-9586-4985-a323-bff655c98192"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Handle_Encoder_A
		 (.oe(tmpOE__Handle_Encoder_A_net),
		  .y({1'b0}),
		  .fb({Net_1072}),
		  .io({tmpIO_0__Handle_Encoder_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Handle_Encoder_A_net),
		  .interrupt({tmpINTERRUPT_0__Handle_Encoder_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Handle_Encoder_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Handle_Encoder_B_net;
	wire [0:0] tmpIO_0__Handle_Encoder_B_net;
	wire [0:0] tmpINTERRUPT_0__Handle_Encoder_B_net;
	electrical [0:0] tmpSIOVREF__Handle_Encoder_B_net;

	cy_psoc3_pins_v1_10
		#(.id("5497ccb0-c41e-4bed-9f49-b2280d2d6b63"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Handle_Encoder_B
		 (.oe(tmpOE__Handle_Encoder_B_net),
		  .y({1'b0}),
		  .fb({Net_1073}),
		  .io({tmpIO_0__Handle_Encoder_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Handle_Encoder_B_net),
		  .interrupt({tmpINTERRUPT_0__Handle_Encoder_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Handle_Encoder_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Timer_v2_80_10 Steering_Timer (
        .reset(Net_291),
        .interrupt(Net_1077),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1081),
        .tc(Net_1082),
        .clock(Net_293));
    defparam Steering_Timer.CaptureCount = 2;
    defparam Steering_Timer.CaptureCounterEnabled = 0;
    defparam Steering_Timer.DeviceFamily = "PSoC5";
    defparam Steering_Timer.InterruptOnCapture = 0;
    defparam Steering_Timer.InterruptOnTC = 1;
    defparam Steering_Timer.Resolution = 8;
    defparam Steering_Timer.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Steering_PWM_net;
	wire [0:0] tmpFB_0__Steering_PWM_net;
	wire [0:0] tmpIO_0__Steering_PWM_net;
	wire [0:0] tmpINTERRUPT_0__Steering_PWM_net;
	electrical [0:0] tmpSIOVREF__Steering_PWM_net;

	cy_psoc3_pins_v1_10
		#(.id("fbcc3ec6-f8bf-4e1b-9b5d-8406e6447d68"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Steering_PWM
		 (.oe(tmpOE__Steering_PWM_net),
		  .y({Net_311}),
		  .fb({tmpFB_0__Steering_PWM_net[0:0]}),
		  .io({tmpIO_0__Steering_PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__Steering_PWM_net),
		  .interrupt({tmpINTERRUPT_0__Steering_PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Steering_PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Steering_Dir_net;
	wire [0:0] tmpFB_0__Steering_Dir_net;
	wire [0:0] tmpIO_0__Steering_Dir_net;
	wire [0:0] tmpINTERRUPT_0__Steering_Dir_net;
	electrical [0:0] tmpSIOVREF__Steering_Dir_net;

	cy_psoc3_pins_v1_10
		#(.id("3252715a-43b3-4818-a181-6456404418a1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Steering_Dir
		 (.oe(tmpOE__Steering_Dir_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Steering_Dir_net[0:0]}),
		  .io({tmpIO_0__Steering_Dir_net[0:0]}),
		  .siovref(tmpSIOVREF__Steering_Dir_net),
		  .interrupt({tmpINTERRUPT_0__Steering_Dir_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Steering_Dir_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_11 PWM_Steer (
        .reset(Net_1084),
        .clock(Net_325),
        .tc(Net_1448),
        .pwm1(Net_1449),
        ...
        .ph1(Net_1457),
        .ph2(Net_1458));
    defparam PWM_Steer.Resolution = 16;
