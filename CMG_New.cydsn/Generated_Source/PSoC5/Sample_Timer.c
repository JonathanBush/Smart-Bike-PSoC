...
{
   #if(Sample_Timer_UsingFixedFunction)
       return ((uint8)CY_GET_REG16(Sample_Timer_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG8(Sample_Timer_PERIOD_LSB_PTR));
   #endif /* (Sample_Timer_UsingFixedFunction) */
}
...
void Sample_Timer_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(Sample_Timer_PERIOD_LSB_PTR, period);
...
{
   #if(Sample_Timer_UsingFixedFunction)
       return ((uint8)CY_GET_REG16(Sample_Timer_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG8(Sample_Timer_CAPTURE_LSB_PTR));
   #endif /* (Sample_Timer_UsingFixedFunction) */
}
...
void Sample_Timer_WriteCounter(uint8 counter) 
{
    ...
    #else
        CY_SET_REG8(Sample_Timer_COUNTER_LSB_PTR, counter);
